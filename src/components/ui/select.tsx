  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // overflow-hidden + min-w-0 asegura que el trigger no crezca más allá de su contenedor,
        // y flex-1 con truncate recorta el texto largo con ellipsis (...)
        "text-left [&>span]:flex-1 [&>span]:min-w-0 [&>span]:truncate",
